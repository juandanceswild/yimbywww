...
--
-- Table structure for table `e5lawmcquw_adrotate_blocks`
--

DROP TABLE IF EXISTS `e5lawmcquw_adrotate_blocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `e5lawmcquw_adrotate_blocks` (
...
--
-- Dumping data for table `e5lawmcquw_adrotate_blocks`
--

LOCK TABLES `e5lawmcquw_adrotate_blocks` WRITE;
/*!40000 ALTER TABLE `e5lawmcquw_adrotate_blocks` DISABLE KEYS */;
/*!40000 ALTER TABLE `e5lawmcquw_adrotate_blocks` ENABLE KEYS */;
UNLOCK TABLES;
