...
/*--- AdRotate values ---------------------------------------*/
define("ADROTATE_DISPLAY", '3.10.7 Professional');
...
function adrotate_dashboard() {
	...
	add_menu_page('AdRotate Pro', 'AdRotate Pro', 'adrotate_ad_manage', 'adrotate', 'adrotate_info', plugins_url('/images/icon.png', __FILE__), '25.8');
	add_submenu_page('adrotate', 'AdRotate Pro > '.__('General Info', 'adrotate'), __('General Info', 'adrotate'), 'adrotate_ad_manage', 'adrotate', 'adrotate_info');
	if($adrotate_server['adrotate_server_puppet'] == 0) {
		add_submenu_page('adrotate', 'AdRotate Pro > '.__('Manage Ads', 'adrotate'), __('Manage Ads', 'adrotate'), 'adrotate_ad_manage', 'adrotate-ads', 'adrotate_manage');
	}

	add_submenu_page('adrotate', 'AdRotate Pro > '.__('Manage Groups', 'adrotate'), __('Manage Groups', 'adrotate'), 'adrotate_group_manage', 'adrotate-groups', 'adrotate_manage_group');
	if($adrotate_server['adrotate_server_puppet'] == 0) {
		...
		if($adrotate_config['enable_advertisers'] == 'Y' AND $adrotate_config['enable_editing'] == 'Y') {
			add_submenu_page('adrotate', 'AdRotate Pro > '.__('Moderate', 'adrotate'), __('Moderate Adverts', 'adrotate'), 'adrotate_moderate', 'adrotate-moderate', 'adrotate_moderate');
		}
	}
	...
	add_submenu_page('adrotate', 'AdRotate Pro > '.__('Settings', 'adrotate'), __('Settings', 'adrotate'), 'manage_options', 'adrotate-settings', 'adrotate_options');
	
	if($adrotate_config['enable_advertisers'] == 'Y' AND $adrotate_server['adrotate_server_puppet'] == 0) {
		add_menu_page(__('Advertiser', 'adrotate'), 'AdRotate Pro > '.__('Advertiser', 'adrotate'), 'adrotate_advertiser', 'adrotate-advertiser', 'adrotate_advertiser', plugins_url('/images/icon.png', __FILE__), '25.9');
