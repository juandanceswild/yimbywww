	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
      	...
      	<tr>
	        ...
	        <td colspan="3">
		        <input tabindex="34" name="adrotate_timeframelength" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_banner->timeframelength;?>" /> <select tabindex="34" name="adrotate_timeframe">
