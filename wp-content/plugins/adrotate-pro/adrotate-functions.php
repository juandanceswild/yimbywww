...
function adrotate_status($status, $args = null) {
	...
	switch($status) {
		...
		// Support
		case '701' :
			echo '<div id="message" class="updated"><p>Support request sent - Your ticket number is <strong>'.$arguments['ticket'].'</strong>!<br />View and respond to your tickets on the <a href="https://ajdg.solutions/support/view.php" target="_blank">AJdG Solutions Support page</a>.<br />You will receive a confirmation email from the ticket system in within a few minutes. Also check your spam folder!</p></div>';
		break;
		
		case '702' :
			echo '<div id="message" class="updated"><p>Support request could not be sent! Please try again - If the issue persists write to support@adrotateplugin.com!</p></div>';
		break;
